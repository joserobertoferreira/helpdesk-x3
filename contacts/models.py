...
class Contact(models.Model):
    ...
    professional_category = models.CharField(
        db_column='CNTCSP_0', max_length=20, default=''
    )
    ...
    social_security_fund = models.DecimalField(
        db_column='SSCNUM_0', max_digits=28, decimal_places=8, default=0
    )
    ...
    email = models.EmailField(
        db_column='CNTEMA_0', max_length=80, unique=True, default=''
    )
